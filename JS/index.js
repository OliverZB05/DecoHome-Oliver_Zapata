...
function btnClick(btnId){
    ...
    for(let j = 0; j < ShoppingCart.length; j++){
        if(ShoppingCart[j].id == idProduct) {
            //console.log("El producto " + idProduct + " no se puede insertar por que ya esta en el carrito de compras");    
            return
        };
    }
...
SendButton.onclick = () =>{
    ...
    alert("Ya se ha enviado el carrido de compras");
}
//============== Enviar Productos ==============
